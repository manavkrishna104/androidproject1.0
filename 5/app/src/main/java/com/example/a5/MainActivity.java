...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.a5.R.layout.activity_main);
    ...
    private void initializeViews() {
        customerNameField = findViewById(com.example.a5.R.id.customerNameField);
        dateField = findViewById(com.example.a5.R.id.dateField);
        timeField = findViewById(com.example.a5.R.id.timeField);
        breadLengthGroup = findViewById(com.example.a5.R.id.breadLengthGroup);
        length15cm = findViewById(com.example.a5.R.id.length15cm);
        paneerCheckbox = findViewById(com.example.a5.R.id.paneerCheckbox);
        mushroomCheckbox = findViewById(com.example.a5.R.id.mushroomCheckbox);
        onionCheckbox = findViewById(com.example.a5.R.id.onionCheckbox);
        jalapenoCheckbox = findViewById(com.example.a5.R.id.jalapenoCheckbox);
        drinkField = findViewById(com.example.a5.R.id.drinkField);
        orderButton = findViewById(com.example.a5.R.id.orderButton);
    }
